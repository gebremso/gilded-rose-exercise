...
class ProductTest {
    ...
    public void testDatePassZero(){
        ...
        Product product = new Product("Apple", LocalDate.of(2025,5,25));
    ...
    public void testOneDayAfterPurchaseDate(){
        ...
        Product product = new Product("Samsung", LocalDate.of(2025,5, 25));
        assertEquals(1, product.daysPassed(date));
    }

    //M - Many many days pass the purchasing date
    @Test
    public void testManyDayPassPurchaseDate(){
        LocalDate date = LocalDate.of(2025, 5, 26);
        Product product = new Product("Samsung", LocalDate.of(2025,5, 20));
    ...
    public void testYearPassedPurchaseDate(){
        ...
        Product product = new Product("Ipad", LocalDate.of(2024,5, 27));
    ...
    public void testInputBeforePurchaseDate(){
        Product product = new Product("Tablet", LocalDate.of(2025,5,26));
        assertThrows(IllegalArgumentException.class, ()->product.daysPassed(LocalDate.of(2025,5,25)));
    }
