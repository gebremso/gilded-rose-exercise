...
class ItemTest {
    ...
    @Test
    public void testZeroValueForNormalItemAfterOneDay() {
    ...
    @Test
    public void testDecreaseByOneForNormalItemAfterOneDay() {
    ...
    @Test
    public void testManyProductTypeShouldReturnCorrectQualityAndSellIn()  {
    ...
    @Test
    public void testNormalItemQualityBoundaries() {
    ...
    @Test
    public void testBackstageQualityBoundaries() {
    ...
    @Test
    public void testConjuredItemShouldDecreaseTwice() {
    ...
    @Test
    public void testSulfurasItemNeverDecreaseQualityOrSellIn() {
    ...
    @Test
    public void testNormalItemWithNegativeSellInShouldDecreaseTwice() {
        Item normalItem = new Item("Normal", -3, 4);
        assertEquals(2,normalItem.getQuality(LocalDate.now().plusDays(1)));
    ...
    void testQualityBelowZeroThrowsException() {
        assertThrows(RuntimeException.class, () -> new Item("Unsupported Item", 5, -1));
